...
define( 'WC_PRE_ORDERS_VERSION', '1.5.9' );
...
class WC_Pre_Orders {
	...
	public function __construct() {
		...
		// Hook up emails
		foreach ( array( 'wc_pre_order_status_new_to_active', 'wc_pre_order_status_completed', 'wc_pre_order_status_active_to_cancelled', 'wc_pre_orders_pre_order_date_changed', 'wc_pre_orders_pre_ordered' ) as $action ) {
