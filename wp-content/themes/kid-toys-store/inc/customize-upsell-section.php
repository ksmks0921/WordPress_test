 ...
 */
/**
 * Class Kid_Toys_Store_Customizer_Upsell_Section
 */
class Kid_Toys_Store_Customizer_Upsell_Section extends WP_Customize_Section {
	/**
	...
	/**
	 * Kid_Toys_Store_Customizer_Upsell_Section constructor.
	 */
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'Kid_Toys_Store_Customizer_Upsell_Section' );
